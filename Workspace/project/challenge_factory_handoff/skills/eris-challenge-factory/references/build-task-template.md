...
Before implementation, independently verify the official source, actual files, license, redistribution, source size, labels, novelty threshold, CPU feasibility, and source-lookup risk. Stop and report a blocker if any mandatory gate fails.
